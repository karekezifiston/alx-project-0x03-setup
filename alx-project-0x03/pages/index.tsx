...
import { PageRouteProps } from "@/interfaces";  // ← Interface imported from centralized location
...
export default function Home() {
  ...
  const routeToNextPage = ({ pageRoute }: PageRouteProps) => {  // ← Using imported interface
