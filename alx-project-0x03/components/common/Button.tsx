import { ButtonProps } from "@/interfaces";  // ← Interface imported from centralized location

const Button = ({ buttonLabel, buttonSize, buttonBackgroundColor, action }: ButtonProps) => {  // ← Using imported interface
